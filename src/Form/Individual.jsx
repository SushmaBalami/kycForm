...
import EducationalDetails from "../FormComponent/EducationalDetails";
import AddressDetails from "../FormComponent/AddressDetails";
import SurveyQuestion from "../FormComponent/SurveyQues";
    ...
    <>
      <Layout>
        <div className="main-container">
          <div className="title">BFA-Individuals</div>
          <div className="title-content">
            Financial Advisor Application Form-Individual
          </div>
